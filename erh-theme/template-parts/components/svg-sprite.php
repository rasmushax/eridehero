...
<svg xmlns="http://www.w3.org/2000/svg" style="display:none" aria-hidden="true">
    ...
    <!-- Calculator Money (cost calculator) -->
    <symbol id="icon-tool-calculator-money" viewBox="0 0 24 24" fill="currentColor">
    ...
    <!-- Alert Triangle (warning callout) -->
    ...
    <!-- Review (chat bubble with pencil) -->
    <symbol id="icon-review" viewBox="0 0 24 24" fill="currentColor">
    ...
    <!-- Thumbs Down (Feather) -->
    <symbol id="icon-thumbs-down" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        <path d="M10 15v4a3 3 0 0 0 3 3l4-9V2H5.72a2 2 0 0 0-2 1.7l-1.38 9a2 2 0 0 0 2 2.3zm7-13h2.67A2.31 2.31 0 0 1 22 4v7a2.31 2.31 0 0 1-2.33 2H17"></path>
    </symbol>

    <!-- Stopwatch (acceleration) -->
    <symbol id="icon-stopwatch" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        <circle cx="12" cy="14" r="8"></circle>
        <line x1="12" y1="10" x2="12" y2="14"></line>
        <line x1="16.24" y1="8.76" x2="17.66" y2="7.34"></line>
        <line x1="10" y1="2" x2="14" y2="2"></line>
        <line x1="12" y1="2" x2="12" y2="6"></line>
    </symbol>

    <!-- Cloud Rain (IP rating / weather resistance) -->
    <symbol id="icon-cloud-rain" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    <!-- Tire (tire size) -->
    <symbol id="icon-tire" viewBox="0 0 24 24" fill="currentColor">
    ...
    <symbol id="icon-brake" viewBox="0 0 512 512" fill="none" stroke="currentColor" stroke-width="40" stroke-linecap="round" stroke-linejoin="round">
        <ellipse cx="236.281" cy="276.102" rx="76.713" ry="76.094"/>
        <line x1="236.281" y1="449.194" x2="236.281" y2="486.509"/>
        <line x1="61.781" y1="276.102" x2="24.162" y2="276.102"/>
        <line x1="112.89" y1="398.497" x2="86.29" y2="424.882"/>
        <line x1="386.271" y1="424.882" x2="359.671" y2="398.497"/>
        <line x1="112.89" y1="153.708" x2="86.29" y2="127.322"/>
        <path d="M400.869,273.934l0.165-2.321c0.252-3.546,0.38-7.142,0.38-10.688c0-82.549-67.705-149.708-150.926-149.708c-3.184,0-6.446,0.105-9.696,0.311l-2.326,0.147V21.661l2.094-0.087c3.382-0.141,6.722-0.212,9.928-0.212c64.511,0,125.16,24.919,170.774,70.167C466.878,136.775,492,196.935,492,260.925c0,3.609-0.086,7.187-0.263,10.943l-0.097,2.067H400.869z"/>
        <path d="M236.281,61.567C116.832,61.567,20,157.618,20,276.102s96.832,214.535,216.281,214.535c83.921,0,156.676-47.412,192.532-116.704"/>
    </symbol>

    <!-- Mountain (hill climbing) -->
    <symbol id="icon-mountain" viewBox="0 0 32 32" fill="currentColor">
        <path d="m29.6 22.083-5.42-8.516a3 3 0 0 0-4.652-.511l-1.387 1.387-3.8-7.051a2.647 2.647 0 0 0-4.7.07l-7.365 14.749a2.619 2.619 0 0 0 2.342 3.789h22.833a2.549 2.549 0 0 0 2.149-3.917zm-2.149 1.917h-22.833a.619.619 0 0 1-.553-.895l7.374-14.748a.67.67 0 0 1 1.146-.018l6.535 12.135a1 1 0 0 0 1.76-.948l-1.747-3.245 1.811-1.811a1.012 1.012 0 0 1 .817-.287 1 1 0 0 1 .734.458l5.419 8.516a.548.548 0 0 1-.463.843z"/>
    </symbol>
