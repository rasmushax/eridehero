...
function erh_get_finder_page_config(): array {
    return [
        'escooter' => [
            ...
            'subtitle'         => 'Browse our database of %d electric scooters — filter by specs, compare models, and find deals',
            'short'            => 'E-Scooter',
            'product_type'     => 'Electric Scooter',
            'meta_title'       => 'Electric Scooter Finder – Compare %d+ E-Scooters | ERideHero',
            'meta_description' => 'Find your perfect electric scooter from our database of %d+ models. Filter by speed, range, price, and more. Real specs, real prices, updated daily.',
        ],
        'ebike' => [
            'title'            => 'Electric Bike Finder',
            'subtitle'         => 'Browse our database of %d electric bikes — filter by specs, compare models, and find deals',
            'short'            => 'E-Bike',
            'product_type'     => 'Electric Bike',
            'meta_title'       => 'Electric Bike Finder – Compare %d+ E-Bikes | ERideHero',
            'meta_description' => 'Find your perfect electric bike from our database of %d+ models. Filter by motor, range, price, and more. Real specs, real prices, updated daily.',
        ],
        'eskate' => [
            'title'            => 'Electric Skateboard Finder',
            'subtitle'         => 'Browse our database of %d electric skateboards — filter by specs, compare models, and find deals',
            'short'            => 'E-Skateboard',
            'product_type'     => 'Electric Skateboard',
            'meta_title'       => 'Electric Skateboard Finder – Compare %d+ E-Skateboards | ERideHero',
            'meta_description' => 'Find your perfect electric skateboard from our database of %d+ models. Filter by speed, range, price, and more. Real specs, real prices, updated daily.',
        ],
        'euc' => [
            'title'            => 'Electric Unicycle Finder',
            'subtitle'         => 'Browse our database of %d electric unicycles — filter by specs, compare models, and find deals',
            'short'            => 'EUC',
            'product_type'     => 'Electric Unicycle',
            'meta_title'       => 'Electric Unicycle Finder – Compare %d+ EUCs | ERideHero',
            'meta_description' => 'Find your perfect electric unicycle from our database of %d+ models. Filter by speed, range, price, and more. Real specs, real prices, updated daily.',
        ],
        'hoverboard' => [
            'title'            => 'Hoverboard Finder',
            'subtitle'         => 'Browse our database of %d hoverboards — filter by specs, compare models, and find deals',
            'short'            => 'Hoverboard',
            'product_type'     => 'Hoverboard',
            'meta_title'       => 'Hoverboard Finder – Compare %d+ Hoverboards | ERideHero',
            'meta_description' => 'Find your perfect hoverboard from our database of %d+ models. Filter by speed, range, price, and more. Real specs, real prices, updated daily.',
        ],
    ];
}
