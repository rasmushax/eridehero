                    ...
                    'sub_fields'   => [
                        ...
                        [
                            ...
                            'choices'           => [
                                ...
                                'hill_climb'       => 'Hill Climb Speed (MPH)',
                                'ip_rating'        => 'IP Rating',
                                'tire_size'        => 'Tire Size',
    ...
    private function register_bfdeal_fields(): void {
        acf_add_local_field_group([
            ...
            'fields'   => [
                ...
                [
                    'key'          => 'field_6557444185da5',
                    'label'        => 'Sale Price',
                    'name'         => 'manual_price_now',
                    'type'         => 'number',
                    'prepend'      => '$',
                    'wrapper'      => ['width' => '33'],
                ],
                [
                    'key'          => 'field_6557445185da6',
                    'label'        => 'Original Price',
                    'name'         => 'manual_price_was',
                    'type'         => 'number',
                    'prepend'      => '$',
                    'wrapper'      => ['width' => '33'],
                ],
